...
function calcularSalario($salarioMensual) {
  ...
  return $salarioMensual * MESES_EN_EL_AÑO;
}
...
$botonCalcular.onclick = function () {
  ...
  const calcularSalarioAnual = calcularSalario($salarioMensual);

  document.querySelector('#salario-anual').value = calcularSalarioAnual
